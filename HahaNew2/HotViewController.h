...
@interface HotViewController :  UIViewController<UITableViewDelegate, UITableViewDataSource,HahaDelegate,UITabBarDelegate,EGORefreshTableHeaderDelegate,RefreshTableFooterDelegate>
