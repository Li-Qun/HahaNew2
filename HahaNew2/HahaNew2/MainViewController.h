...
@interface   MainViewController :  UIViewController<UITableViewDelegate, UITableViewDataSource,HahaDelegate,UITabBarDelegate,EGORefreshTableHeaderDelegate,RefreshTableFooterDelegate>
