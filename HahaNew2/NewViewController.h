...
@interface NewViewController :  UIViewController<UITableViewDelegate, UITableViewDataSource,HahaDelegate,UITabBarDelegate,EGORefreshTableHeaderDelegate,RefreshTableFooterDelegate>
